...
restaurants.forEach(element => {
    ...
    place.innerHTML=element.location

    const distance=document.createElement(`span`)
    distance.innerHTML=element.distance_from_Customer_house

    const name=document.createElement(`h3`)
    name.innerHTML=element.name

    const foodtyp=document.createElement(`span`)
    foodtyp.innerHTML=element.food_type

    const fortwo=document.createElement(`span`)
    fortwo.innerHTML="₹"+element.price_for_two
    ...
    footer.appendChild(foodtyp)
    footer.appendChild(fortwo)
...
document.getElementById(`alchohol`).addEventListener(`click`,()=>{
...
document.getElementById(`Open`).addEventListener(`click`,()=>{
    const result=restaurants.filter((obj)=>obj.restaurant_open_time>13)
    document.getElementById(`root`).replaceChildren()
    getrestaurant(result)
})
...
document.getElementById(`filters`).addEventListener(`click`,()=>{
    ...
    // document.getElementById(`root`).replaceChildren()
    // getrestaurant(result)
    const hidden=document.getElementById(`filterPopup`)
